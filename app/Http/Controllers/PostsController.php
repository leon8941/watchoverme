...
class PostsController extends Controller
{
    ...
    public function index()
    {
        ...
        SEOMeta::setDescription('Notícias de Overwatch, tudo sobre os campeonatos e rankings, eventos e vídeos. - O Verme');
        ...
        OpenGraph::setDescription('Notícias de Overwatch, tudo sobre os campeonatos e rankings, eventos e vídeos. - O Verme');
        OpenGraph::setTitle('Notícias de OverWatch - O Verme');
