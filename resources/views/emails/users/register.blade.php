...
<ul>
    ...
    <li>Entre no seu perfil de usuário</li>
    <li>Clique em Ativar conta de jogador</li>
    <li>Coloque sua battletag</li>
    <li>Pronto! Seus dados reais do Overwatch serão importados e você será rankeado junto aos demais jogadores
    brasileiros.</li>
</ul>