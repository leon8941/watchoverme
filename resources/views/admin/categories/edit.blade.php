...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('description', old('description',$categories->description), array('class'=>'form-control')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('text', old('text',$categories->text), array('class'=>'form-control ckeditor')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('user_id', 'Author*', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::select('user_id', $user, old('user_id',$categories->user_id), array('class'=>'form-control')) !!}
...
<div class="form-group">
    <div class="col-sm-10 col-sm-offset-2">
      ...
      {!! link_to_route('admin.categories.index', trans('quickadmin::templates.templates-view_edit-cancel'), null, array('class' => 'btn btn-default')) !!}
    </div>
</div>
